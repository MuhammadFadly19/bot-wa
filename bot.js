...
const YT_API = "AIzaSyDD0OfUzCOjVyC_jP1AmY_7fC7XzYcR5sg"; // ganti dengan API key YouTube
const WEATHER_API = "5e9a21afae6892e170bc16ff59be2f2a"; // ganti dengan OpenWeather key
...
client.on("message", async (msg) => {
  ...
  if (text === "menu") {
    return safeReply(msg,
      ...
      `4. *wikipedia <kata>* → Cari di Wikipedia\n` +
